...
public class UpdateShopActivity extends AppCompatActivity {
    ...
    private Shop shopToUpdate = null;
    ...
    private void updateShopInfo(String imageName) {
        ...
        if (!emptyRequiredFields()) {
            ...
            shopToUpdate.setOfficialName(name);
            shopToUpdate.setLocation(location);
            shopToUpdate.setMobile(contact);
            shopToUpdate.setWebsite(website);
            shopToUpdate.setProfileImageName(imageName);
    ...
    private void updateUI(Shop shop) {
        ...
        nameET.setText(shop.getOfficialName());
        locationET.setText(shop.getLocation());
        contactET.setText(shop.getMobile());
                ...
                .addOnSuccessListener(
                        documentSnapshot -> {
                            if (documentSnapshot.exists()) {
                                ...
                                shopToUpdate = shop;
                                if (shop != null) updateUI(shop);
                            } else {
                                Toast.makeText(this, "No details", Toast.LENGTH_SHORT).show();
                            }
                        }
                )
                .addOnFailureListener(e -> Log.w(TAG, "getShop: Failure", e));
